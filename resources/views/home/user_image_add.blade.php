                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('user_image_store', ['film_id'=>$data->id])}}" method="post" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                                ...
                                <table class="table table-bordered" >
                                    ...
                                    @foreach($images as $rs)
                                        <tr>
                                            ...
                                            <td> <a href="{{route('user_image_delete', ['id'=>$rs->id, 'film_id'=>$data->id])}}" onclick="return confirm('Are you sure?')">
